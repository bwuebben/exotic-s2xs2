...
#
# Conservativity note: the presented group SURJECTS onto pi_1(V').  A TRIVIAL
# verdict is therefore valid as-is.  A NONTRIVIAL verdict concerns only the
# presented group and does not establish that pi_1(V') is nontrivial.
