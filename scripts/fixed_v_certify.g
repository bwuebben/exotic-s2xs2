...
#
# This is the proof-level group check.  At (m,n)=(0,0), include the true
# drilled-fiber relation R3 and independently vary every local choice that
...
# Thus 2^5 * 2^3 * 2 * (2*2*2) = 4096 relation systems are checked.  Every
# system must have trivial abelianization and a terminating one-coset table.
...
Print("FIXED V WITH R3: TOTAL=",counts.total,
