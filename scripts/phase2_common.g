...
# Historical finite-quotient input, retained byte-for-word in its old arc
# coordinate so the 56-hour logs remain reproducible. Its n_old corresponds
# to n=n_old+1 in the paper's current y1/Ax indexing; it is not used in the proof.
