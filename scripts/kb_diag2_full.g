...
# completeness.
#
# R3 note (diag_g2_probe.g): without the additional true relation the honest
...
# is a TRUE relation of pi_1(V'), derived from bundle transport (paper: drilled-fiber basis;
